...
export class ActivityApi
{
        ...
        //获取相关的服务
        ticketorderlist(json, callback, showLoading = true) {
          ...
          console.log(header);
          wx.request({
            url: ApiConfig.GetApiUrl() + 'activity/ticketorderlist',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
        ...
        //获取相关的服务
        ticketorderprepay(json, callback, showLoading = true) {
          ...
          console.log(header);
          wx.request({
            url: ApiConfig.GetApiUrl() + 'activity/ticketorderprepay',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
