...
export class CourseApi {
  ...
  comment(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'course/comment',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  commentlist(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'course/commentlist',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  sendnotify(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'course/sendnotify',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  up(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'course/up',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  viewlist(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'course/viewlist',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  favorite(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'course/favorite',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  favoritelist(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'course/favoritelist',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  alldonebydate(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'course/alldonebydate',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  hotrank(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'course/hotrank',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  allbycategory(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'course/allbycategory',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  foreshow(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'course/foreshow',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  search(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'course/search',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
